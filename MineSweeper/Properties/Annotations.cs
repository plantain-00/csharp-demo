...
namespace MineSweeper.Properties
{
    ...
    {
        public ContractAnnotationAttribute([NotNull] string contract) : this(contract,
                                                                             false)
        {
        }
    ...
    {
        public UsedImplicitlyAttribute() : this(ImplicitUseKindFlags.Default,
    ...
    {
        public MeansImplicitUseAttribute() : this(ImplicitUseKindFlags.Default,
                                                  ImplicitUseTargetFlags.Default)
        {
        }
