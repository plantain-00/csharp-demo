...
namespace search.demo
{
    ...
    {
        private static readonly DirectoryInfo INDEX_DIR = new DirectoryInfo("index");
        ...
        private static void Main(string[] args)
        {
            ...
            using (var iw = new IndexWriter(FSDirectory.Open(INDEX_DIR), analyzer, true, IndexWriter.MaxFieldLength.LIMITED))
            {
        ...
        {
            using (var searcher = new IndexSearcher(FSDirectory.Open(INDEX_DIR), true))
            {
                var qp = new QueryParser(Version.LUCENE_30, "body", analyzer);
